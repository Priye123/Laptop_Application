package com.priye.pcbook.sample;
...
//protoc has generated lot of builders,classes & methods for use
    public Keyboard NewKeyboard() {
        return Keyboard.newBuilder()
                .setLayout(randomKeyboardLayout())
                .setBacklit(rand.nextBoolean())
                .build(); //build() here is to build the keyboard object and return it
    }
    ...
    public Storage NewSSD() {
        Memory memory = Memory.newBuilder()
                .setValue(randomInt(128, 1024))//128 to 1024 gigabyte
                .setUnit(Memory.Unit.GIGABYTE)
                .build();
    ...
    public Storage NewHDD() {
        Memory memory = Memory.newBuilder()
                ...
                .setUnit(Memory.Unit.TERABYTE)//1 to 6 terabyte
                .build();
    ...
    public Laptop NewLaptop() {
        ...
        return Laptop.newBuilder()
                ...
                .setCpu(NewCPU())
                .setRam(NewRAM())
                .addGpus(NewGPU())//note for that gpu's & storage's, we use add() instead of set() bcoz they are repeated fields which is a list of objects instead of 1 single object
                .addStorages(NewSSD())
                .addStorages(NewHDD())
                .setScreen(NewScreen())
