...
public class LaptopService extends LaptopServiceGrpc.LaptopServiceImplBase {
    ...
    public void createLaptop(CreateLaptopRequest request, StreamObserver<CreateLaptopResponse> responseObserver) {
        Laptop laptop = request.getLaptop();//get laptop object from request i.e from client
        ...
        if (id.isEmpty()) {
            ...
            try {
                ...
                responseObserver.onError( //if catch error,return it to the client
        ...
        //toBuilder().build() to build the object of protobuff class
        Laptop other = laptop.toBuilder().setId(uuid.toString()).build();
        //save other laptop to the temporary database before sending the response
        try {
        ...
        responseObserver.onNext(response);//sending data back to the client
        responseObserver.onCompleted();//close the call(connection b/w grpc client & server for this respective API is closed)
    ...
    public void searchLaptop(SearchLaptopRequest request, StreamObserver<SearchLaptopResponse> responseObserver) {
        ...
        laptopStore.Search(filter, new LaptopStream() {
            ...
            public void Send(Laptop laptop) {
                ...
                responseObserver.onNext(response);//send this response to the client
            }
        });
